...
**edit-46 makes six raw sources in a row with D = 0** (p05 = −88.7 dB, p01 = −119). This OBS chain gates at recording, so "raw" never yet meant a raised floor here — measure, but expect the canned −35/−30/−35/−25 gates to stand.
