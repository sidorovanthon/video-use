...
description: "Canonical OBS-talking-head recipe now lives IN THE REPO at C:\\Users\\sidor\\repos\\video-use\\docs\\settings_reference.md (git-backed); grade default v7-lift for \"Losing Context\" series, v7-contrast for \"Migrating\" series"
metadata: 
  node_type: memory
  type: reference
...
*(Reconstructed 2026-07-13 after NUL corruption.)*
