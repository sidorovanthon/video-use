...
metadata: 
  ...
  modified: 2026-07-27T03:38:36.208Z
---
...
**Why:** all four sources are "dim", but dimness alone doesn't decide — what matters is
...
**How to apply:** never inherit a Systems Analysis grade from the previous part in either
direction. Run `grade_sheet.py scan` + `sheet`, show the 5-up, wait for the explicit call.
Two consecutive v7-contrast picks (edit-31, edit-32) are a leaning, not a default.
